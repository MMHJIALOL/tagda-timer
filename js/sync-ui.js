 ...
 * signed in.
 *
 * The avatar comes from the Google account and is never uploaded: there is
 * no "change avatar" here, because Cloud Storage — the only thing in this
 * app that would have needed it — is behind Firebase's Blaze plan on
 * projects created after 2024, and a button that always fails is worse
 * than no button. If it ever comes back, base64 in the Realtime Database is
 * the free route; a 128px JPEG is about 11 KB.
 */
